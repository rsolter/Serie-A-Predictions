...
cmSVM <-confusionMatrix(SVMPredictions, atl_test$result)
print(cmSVM)
...
cmTree <-confusionMatrix(DTPredictions, atl_test$result)
print(cmTree)

# Baseline accuracy for RF is 
...
cmNaive <-confusionMatrix(NaivePredictions, atl_test$result)
...
ALT_Model_list <- list(svm = SVModel,
                   tree = DecTreeModel,
                   NB = NaiveModel,
                   NN = NNModel)

extractProb(ALT_Model_list)
