...
teams <- c("athletico-bilbao","atletico-madrid","cd-alaves","cd-leganes","celta-vigo",
           "deportivo-la-coruna","espanyol-barcelona","fc-barcelona","getafe-cf","girona-fc","levante-ud",
           "malaga-cf","rayo-vallecano","real-betis","real-madrid","real-sociedad","real-valladolid",
...
two_to_five <- team_output
five_to_12<-team_output
thirteen_to_22 <- team_output
full<-c(two_to_five,five_to_12,thirteen_to_22)
# glimpse(full)
